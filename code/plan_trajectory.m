...
% Generates the end-effector trajectory across 7 phases:
% Approach -> Track -> Transit -> Lower -> Screw (90° rot) -> Hold -> Return
%
% Args:
...
% Construct the trajectory point-by-point across all 7 phases
for k = 1:N
    tk = t(k);
